...
class frontController_v2_th extends Controller
{
    // หน้าแรก *******************************************************************
    ...
    // หน้า station ****************************************************************************
        public function station($train_station_url_en)
        {
            ...
            ->where('train_station_custom.active_status','=','1')
            ->where('train_station_custom.train_station_url','=',$train_station_url_en)->first();
            if ($station) {
    ...
    public function newsDetail($id,$keyword)
    {
        ...
        // $data['url'] = route('newsDetail',[$news->id,str_replace([' ', '/' , '%20' , '%28','%29'], ['-','-','-','-','-'], $news->news_title)
        // ]);

        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $headernews = str_replace([' ', '/' , '%20' , '%28','%29'], ['-','-','-','-','-'], $news->news_title_en);
        $url = env('URLEN').'/Articles/'.$news->id.'/'.$headernews;
        $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
    ...
    {
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $url = env('URLEN').'/Looking-to-rent-a-condo/buy-a-condo'; $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
    ...
    {
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $url = env('URLEN').'/work-with-us'; $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
    ...
    {
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $url = env('URLEN').'/our-service'; $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
    ...
    {
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $url = env('URLEN').'/Contact-us'; $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
    ...
    {
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $url = env('URLEN').'/Payment'; $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
    ...
    {
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
        $url = env('URLEN').'/Condo-for-rent/condo-for-sale'; $data['url'] = $url;
        // ต้องใส่เพื่อเปลี่ยนภาษา******************************************
