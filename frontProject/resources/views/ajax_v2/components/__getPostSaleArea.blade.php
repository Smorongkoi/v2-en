    ...
    <div class="container mt-2 mb-2 d-block d-sm-none">
        <div class="row">
            @foreach ($pinList as $postData)
                    ...
                    @include('frame_v2.include-condo.card-premium-sale-mobile')
            @endforeach            
        </div>
    </div>
        ...
        <div class="card mb-3 d-none d-xl-block">
            ...
            <div class="p-3"> 
                <table class="table table-borderless">
                    <thead>
                        @foreach ($pinList as $postData)
                            @include('frame_v2.include-condo.card-premium-sale')
    ...
    <div class="container mt-2 mb-2 d-block d-sm-none">
        <div class="row">
            @foreach ($normalList as $postData)
                @include('frame_v2.include-condo.card-normal-sale-mobile')
        ...
        <div class="card mb-3 d-none d-xl-block">
            ...
            <div class="p-3"> 
                <table class="table table-borderless">
                    <thead>
                        @foreach ($normalList as $postData)
                        @include('frame_v2.include-condo.card-normal-sale')
