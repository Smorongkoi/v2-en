...
{{-- ไทย --}}
@section('title-th', 'Scancondo : คุณสมบัติผู้กู้แต่ละธนาคาร')
@section('facebook-title-th', 'Scancondo : คุณสมบัติผู้กู้แต่ละธนาคาร')

@section('title-en', 'Scancondo | Loan applicant requirements')
@section('facebook-title-en', 'Scancondo | Loan applicant requirements')

@section('meta-description-th','Scancondo ตัวแทน (Agent) ให้บริการหาห้อง หาเช่า คอนโดในทำเลที่ดี ห้องสวย
พร้อมเข้าอยู่ ตามความต้องการและงบประมาณของคุณผ่านระบบฐานข้อมูลขนาดใหญ่ของเรา | คุณสมบัติผู้กู้แต่ละธนาคาร')
@section('meta-description-en','Find your room easily with Scancondo.com. There are a lot of great room you can choose. Great condominium, location, facilities and good room decoration. | Loan applicant requirements')

@section('meta-keywords-th','คุณสมบัติผู้กู้แต่ละธนาคาร, เครื่องมือสำหรับอสังหาฯ')
@section('meta-keywords-en','Loan applicant requirements, Real estate, realtor')
    ...
    <section id="breadcrumbs" class="breadcrumbs d-none d-xl-block">        
        ...
        <div class="container text-center d-none d-md-block">  
            <ol>
                ...
                <li>คุณสมบัติผู้กู้แต่ละธนาคาร</li>
            </ol>
    ...
    <section id="breadcrumbs" class="breadcrumbs d-none d-xl-block">        
        ...
        <div class="container text-center d-none d-md-block">  
            <ol>
                ...
                <li>Loan applicant requirements</li>
            </ol>
  ...
  <section id="schedule" class="section-with-bg calculatetoon">
    <div class="container text-center" data-aos="fade-up">
      ...
      <div class="btn-group w-90" role="group"  data-aos="fade-up" data-aos-delay="100">
        <a href="{{ route('font-calculate4') }}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="calculator active" id="calculator-1">
                    <div class="row">
                          <div class="col-md-12 col-12 p-4">
                            <!--table-->
                            @include('calculate_v2.requirement-th')                                
                            <!--table-->
                          </div>
                    </div>
            ...
            <div class="detail">
                <div class="calculator active" id="calculator-1">
                    <div class="row">
                          <div class="col-md-12 col-12 p-4">
                            <!--table-->
                            @include('calculate_v2.requirement-en')                                
                            <!--table-->
                          </div>
                    </div>
