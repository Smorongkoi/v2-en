                ...
                <ul class="nav nav-tabs nav-fill">
                    ...
                    <li class="nav-item">
                      <a class="nav-link @if($type == 1) active @endif" 
                       href="{{ $rent_url }}"
                      ><b><i class="fas fa-key"></i> Rent (<span id="showPostRent-mobile"></span>&nbsp; )</b></a>
                    </li>
                    ...
                    <li class="nav-item">
                      ...
                      href="{{ $sale_url }}" 
                      ><b><i class="fas fa-building"></i> Sell (<span id="showPostSale-mobile"></span>&nbsp; )</b></a>
                    </li>
                </ul>
