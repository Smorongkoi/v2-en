    ...
    <a href="{{ $postData['post_url'] }}" target="_blank">
        ...
        @switch($postData['post_status'])
                    ...
                    @if ($summary < 0)
                        ...
                        @elseif ($summary<-15)
                            style="border:2px solid #faa783"
                        @else 
                            style="border:2px solid #faa783"  
                        @endif
                    @else
                        style="border:3px solid #f66022"
                    @endif                         
                    @break
        ...
        >
            ...
            alt="{{ $postData['post_header'] }}" style="height: 230px;object-fit : cover;">
                ...
                @switch($postData['post_status'])
                    @case(1)
                        <div class="badge mt-1">
                            ...
                            <span class="btn-outline-success">Available &nbsp;<i class="fas fa-check blink"></i></span> 
                        </div>                            
                    @break
                    ...
                    @case(0)
                        <div class="badge mt-1">
                            ...
                            <span class="btn-outline-danger">Rented &nbsp;
            ...
            <div class="p-2 pt-1">                    
                <h3 class="heading premium-h3">
                    <span class="f-rent">Rent</span> : {{ $postData['post_header'] }}                    
                </h3>
                <div class="mt-1">
                                    ...
                                    @switch($postData['post_status'])
                                        @case(1)
                                            {{-- อัพเดตวันที่ --}}
                                                @if ($summary < 0)
                                                        ...
                                                        @else
                                                            <b>
                                                                <i class="fas fa-star fa-spin f-rent"></i> Updated : &nbsp;
                                                                <span style="color: #16ad29">
                                                                    {{-$summary}} days ago
                                                                </span>
                                                                <i class="fas fa-star fa-spin f-rent"></i> 
                                                            </b><br>
                                        ...
                                        @case(0) 
                                            @if ($summary < 0)
                                                        ...
                                                        <br><br>
                                                        <span  style="color: #fe0000">Contract Expire</span><br>
                                                        {{ Date('d M Y',
                                                        strtotime($postData['post_contract_expire']))
                                                        }}
                                                        @elseif ($summary<-30)
                                                        <b><i class="far fa-times-circle" style="color: #848fa8"></i>
                                                            <span style="color: #a5aec0">
                                                                Updated :  a month ago
                                                            </span>
                    ...
                    {{-- <div class="text-center">
                        <div class="mt-1">
                            <span class="text1">Rental Rates <s class="text2">
                                {{ number_format($postData['post_price']*1.05, 0) }}.-
                            </s></span> &nbsp;&nbsp;
                            <a href="{{ $postData['post_url'] }}" class="btn f-rent" target="_blank"><i class="fas fa-caret-right  blink"></i> Click</a>
                       </div>
                    </div> --}}

                    <div class="mt-0 text-center">
                        <h3 class="mb-0 font-weight-semibold">
                           <strong style="font-size: 1.5em;font-weight:bold"> {{ number_format($postData['post_price'], 0) }} </strong><br>
                            <span style="font-size: 0.7em">THB/Month</span>
