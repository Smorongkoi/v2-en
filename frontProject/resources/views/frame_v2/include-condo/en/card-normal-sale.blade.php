                            ...
                            <table class="table cardrenttoon table-sm">
                                ...
                                <tr>
                                    ...
                                    <th>status :
                                        @switch($postData['post_status'])
                                            ...
                                            <span style="color: #16ad29">Buy now!</span> @break
                                            @case(0) <i class="fas fa-times" style="color: #fe0000"></i>  
                                            <span style="color: #fe0000">Sold out</span> @break    
                                        @endswitch
                                    </th>
                                    ...
                                    <td>
                                        ...
                                        <i class="fa fa-star f-sale"></i>
                                        <i class="fa fa-star f-sale"></i>
                                        <i class="fas fa-star-half-alt f-sale"></i>
                                        <i class="far fa-star f-sale"></i>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-muted">Selling Price (Baht)</div>
                                ...
                                <tr>
                                        ...
                                        @switch($postData['post_status'])
                                            @case(1)
                                                <button type="button" class="btn btn-sm btn-outline-success" style="width: 130px">
                                                    <i class="icon-cart-add mr-2"></i> Buy Now  &nbsp;<i class="fas fa-check blink"></i>
                                                </button>
                                            ...
                                            @case(0)
                                                <button type="button" class="btn btn-sm btn-outline-danger">
                                                    <i class="icon-cart-add mr-2"></i> Sold Out  &nbsp;<i class="fas fa-times blink"></i>
                                                </button>
                                    ...
                                    <td colspan="2"  class="text-center">
                                        Additional Details <i class="fas fa-caret-right blink f-sale"></i>  
