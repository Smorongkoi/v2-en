...
// Route::post('getPostLandmark/{type}', [frontController_toon::class, 'getPostLandmark'])
// ->name('getPostLandmark');
...
//ของปาร์ก*****************************************************************************
//หน้าทีมงาน
Route::get('/epaymentslip', [frontController_v2::class, 'ourteam'])->name('ourteam');
//ของปาร์ก*****************************************************************************
